...
{
    public abstract class BaseInputManager<T> : Singleton<T> where T : Component
    {
        ...
        /// </summary>
        /// <typeparam name="U">The expected type of the input value.</typeparam>
        ...
        protected U GetActionValue<U>(string actionName) where U : struct
        {
            var action = _playerInput.actions[actionName];
