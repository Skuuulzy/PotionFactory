...
namespace TelePresent.AudioSyncPro
{
    ...
    public class ASP_AudioSourceEditorDisplayer
    {
        ...
        public static void DrawSoundSettings(AudioSourcePlus audioSourcePlus)
        {
            ...
            string[] sampleSizeOptions = { "256", "512", "1024", "2048", "4096", "Disable Spectrum Analysis" };
            int[] sampleSizeValues = { 256, 512, 1024, 2048, 4096, -1 }; // Use -1 for "Disable Spectrum Data"
