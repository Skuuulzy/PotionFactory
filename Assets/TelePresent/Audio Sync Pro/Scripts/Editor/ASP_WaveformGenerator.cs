...
namespace TelePresent.AudioSyncPro
{
    ...
    public static class WaveformDrawer
    {
        ...
        public static void DrawWaveform(Rect rect, float[] waveform, Color outlineColor, Color fillColor, bool fill = true, float simplificationFactor = 1.1f, float simplificationThreshold = 0.02f)
        {
