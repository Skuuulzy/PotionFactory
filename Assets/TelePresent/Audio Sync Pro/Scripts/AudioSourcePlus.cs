...
namespace TelePresent.AudioSyncPro
{
    ...
    public class AudioSourcePlus : MonoBehaviour
    {
            ...
            set
            {
                if (sampleSize != value)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Debug.LogError("Invalid SampleSize value. Must be a positive integer or -1 for 'Disable Spectrum Data'.");
                        }
                    }
                }
            }
        ...
        [SerializeField]
        private float[] precomputedRMSValues;
    ...
    return;
            ...
            audioSource.GetSpectrumData(leftChannelSpectrum, 0, FFTWindow.BlackmanHarris);
            audioSource.GetSpectrumData(rightChannelSpectrum, 1, FFTWindow.BlackmanHarris);
