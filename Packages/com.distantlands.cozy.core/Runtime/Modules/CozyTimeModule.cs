...
namespace DistantLands.Cozy
{
    ...
    public class CozyTimeModule : CozyModule
    {
        ...
        public float modifiedTimeSpeed
        {
            get
            {
                return perennialProfile.timeMovementSpeed * (perennialProfile.pauseTime ? 0 : 1) * (perennialProfile.modulateTimeSpeed ? perennialProfile.timeSpeedMultiplier.Evaluate(currentTime) / 1440 : 1);
            }
        }
