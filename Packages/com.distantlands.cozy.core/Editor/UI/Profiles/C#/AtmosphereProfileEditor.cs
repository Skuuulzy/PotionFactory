...
namespace DistantLands.Cozy.EditorScripts
{
    ...
    public class AtmosphereProfileEditor : Editor
    {
        ...
        public void RenderCelestialsSettings()
        {
            ...
            starMap.BindProperty(serializedObject.FindProperty("starMap"));
            ...
            galaxyMap.BindProperty(serializedObject.FindProperty("galaxyMap"));
            ...
            lightScatteringMap.AddToClassList("mb-md");
